...
class _UploadPhotoPageState extends State<UploadPhotoPage> {
  ...
  void initState() {
    super.initState();
    siswaController.descController.clear();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Upload Hasil Pembatik'),
      ),
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  controller: siswaController.descController,
              ...
              Obx(() => (siswaController.submit.value)
                  ? const Center(
